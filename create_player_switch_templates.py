...
#where the the ith element of the list is the template that corresponds to the ith permutaion in 
#list(permutations(range(1,10))). The pickled file is about 140mb.
